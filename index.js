...
console.log(createMenuItem('enchiladas', 10.5, 'lunch'));
console.log(createMenuItem('shrimp', 15.5, 'dinner'));
console.log(createMenuItem('omelet', 5.95, 'breakfast'));
...
reviews.push({ name: 'John', rating: 4.7, feedback: 'Great place to eat!' });
console.log(reviews);
